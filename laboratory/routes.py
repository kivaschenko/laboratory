def includeme(config):
    ...
    config.add_route('normative_edit', '/normatives/edit', factory='laboratory.security.LabFactory')
    ...
    config.add_route('delete_solution', 'delete-solution/{solution_id}', factory='laboratory.security.LabFactory')
    ...
    config.add_route('recipes_edit', '/recipes/edit', factory='laboratory.security.LabFactory')
    config.add_route('delete_recipe', '/delete-recipe/{recipe_id}', factory='laboratory.security.LabFactory')
